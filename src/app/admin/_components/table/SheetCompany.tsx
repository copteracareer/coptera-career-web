...
export const SheetCompany: React.FC<SheetComponentProps> = ({
  isOpen,
  onClose,
  companyData,
}) => {
        ...
        <ScrollArea className="h-screen">
          <div className="max-w-[392px]">
            ...
            <div className="flex flex-col items-center mt-6">
              ...
              <h2 className="text-xl font-bold mt-5">{companyData.name}</h2>

              <p className="text-gray-500 mt-[14px] mb-4">
                {companyData.brand}
              </p>
            ...
            <div className="p-6">
              ...
              <div className="flex flex-col space-y-2">
                <div className="flex justify-between">
                  <p className="w-1/2 text-gray-500">Total Position</p>
                  <span className="flex-1 text-center">:</span>
                  <p className="w-1/2 text-right">
                    {companyData.total_position}
                  </p>
                </div>
                <div className="flex justify-between">
                  <p className="w-1/2 text-gray-500">Company Type</p>
                  <span className="flex-1 text-center">:</span>
                  <p className="w-1/2 text-right">{companyData.type}</p>
                </div>
                <div className="flex justify-between">
                  <p className="w-1/2 text-gray-500">Post Date</p>
                  <span className="flex-1 text-center">:</span>
                  <p className="w-1/2 text-right">
